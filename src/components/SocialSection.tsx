              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <a 
                    ...
                    className="flex items-center gap-3 bg-brand-yellow hover:bg-brand-yellow-alt text-brand-dark-azure px-5 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                  >
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-brand-dark-azure hover:bg-brand-azure text-white px-5 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
